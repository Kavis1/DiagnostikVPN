...
func setWindowsProxy(proxyServer string) (WindowsProxyState, error) {
	prev := readWindowsProxyState()
...
func restoreWindowsProxy(prev WindowsProxyState) {
	if prev.WasEnabled {
...
func readWindowsProxyState() WindowsProxyState {
	st := WindowsProxyState{}
